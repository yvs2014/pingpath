...
GtkWidget* notifier_init(uint ndx, GtkWidget *base);
void notifier_inform(const char *fmt, ...);
gboolean notifier_get_visible(uint ndx);
void notifier_set_visible(uint ndx, gboolean visible);
