...
enum { ENT_STR_NONE, ENT_STR_CYCLES, ENT_STR_IVAL, ENT_STR_QOS, ENT_STR_PLOAD, ENT_STR_PSIZE,
  ENT_STR_LOGMAX, ENT_STR_GRAPH, ENT_STR_GEXTRA, ENT_STR_LEGEND, ENT_STR_MAX };
enum { OPT_TYPE_INT, OPT_TYPE_PAD, OPT_TYPE_INFO, OPT_TYPE_STAT, OPT_TYPE_RECAP, OPT_TYPE_MAX };
