...
#define OPT_MSRC_HDR     _("Hop Info multi-sources")
...
#define ELEM_MSRC_HDR    _("<multi-source>")
#define ELEM_MSRC_TIP    _("More than one info-source")
